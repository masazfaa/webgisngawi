(function (factory, window) {
    ...
    L.Measure = {
        linearMeasurement: "Jarak",
        areaMeasurement: "Luas",
        start: "Start",
        meter: "m",
        meterDecimals: 0,
        kilometer: "km",
    ...
    L.Control.Measure = L.Control.extend({
        ...
        _buildItems: function () {
            ...
            ele_link_line.innerText = "📏 " + L.Measure.linearMeasurement; // Added symbol
            ele_link_line.href = "#";
            ...
            var ele_link_area = L.DomUtil.create("a", "start", ele_li);
            ele_link_area.innerText = "📐 " + L.Measure.areaMeasurement; // Added symbol
            ele_link_area.href = "#";
